	...
	<div id="login-register-password">
		...
		<div class="tab_container_login">
			<div id="tab1_login" class="tab_content_login">
				...
				<?php $login = $_GET['login']; if($login == 'failed'): ?>
	            	<div class="error">
			            <p><?php _e( 'Login failed. Please try again.' ); ?></p>
		            </div>
	            <?php endif; ?>
				...
				<form method="post" action="<?php bloginfo('url') ?>/wp-login.php" class="wp-user-form">
					...
					<div class="login_fields">
						...
						<input type="submit" name="user-submit" value="<?php _e('Login'); ?>" tabindex="14" class="button button-primary" />
			...
			<div id="tab2_login" class="tab_content_login" style="display:none;">
				...
				<form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="wp-user-form">
					...
					<div class="login_fields">
						...
						<input type="submit" name="user-submit" value="<?php _e('Sign up'); ?>" class="button button-primary" tabindex="103" />
			...
			<div id="tab3_login" class="tab_content_login" style="display:none;">
				...
				<form method="post" action="<?php echo site_url('wp-login.php?action=lostpassword', 'login_post') ?>" class="wp-user-form">
					...
					<div class="login_fields">
						...
						<input type="submit" name="user-submit" value="<?php _e('Reset my password'); ?>" class="button button-primary" tabindex="1002" />
