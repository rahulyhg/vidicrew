...
Tags: google drive, google drive upload, media library, google drive plugin, gallery, featured image, remote upload, file hosting, image, media, pictures, links, images, post, upload, hosting storage, google, shortcode, image galleries, album, drive, embed, gdrive, google embed, video
...
[youtube http://www.youtube.com/watch?v=CXPRd8Hv2Y8]
...
* Option to delete virtual/dummy images directory/folder added
* Oveerride default option for images rewrite added
* Minor bug fixed
* Tested up to 4.7.2
...
* Broken url fixed
* No physical directory for dummy url, htaccess removed
* Dummy url's pattern added
* Bugs fixed 

= 2.4.2 =

* Error on dummy image url fixed
* Custom dummy images directory added
* Option to add filename prefix on dummy image url added

= 2.4.1 =

* Error url deprecated Google Drive web hosting fixed
