...
function getGals($paged){
	...
	if( $my_query->have_posts() ) {
		...
		while ($my_query->have_posts()) : $my_query->the_post(); 
			echo '<tr><td><div class="ui-corner-all" style="width:32px;height:32px; overflow:hidden;"><img src="' .GD_BASE_PATH. get_post_meta( get_the_ID(), 'sampleImage', true ) . '" title="'.get_the_ID().'" height="32px" /></div></td>
		...
		endwhile;
		echo '</table><small>*Embed gallery: copy shortcode, paste into your post editor.</small>';
